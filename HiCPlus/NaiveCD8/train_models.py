...
factor = 'NaiveCD8'
inputfile = "/data3/xiongdan/cohesin_mm10_CD8/1.downsampling/3way.NaiveCD8_WT_SMC1A_vs_SA2KO_SMC1A_vs_BRD4SA2DKO_SMC1A/NaiveCD8_WT_ChIAPET_SMC1A.intra_iPET_ALL.DOWNSAMPLING_24M.hic"
outmodel = f'/public1/xinyu/CohesinProject/DeepLearning_Cohesin/0.HiCPlus/{factor}'
# chrN = 21
# scale = 16
## 对染色体进行循环，逐条进行训练
