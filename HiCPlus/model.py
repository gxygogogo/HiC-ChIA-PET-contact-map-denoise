...
conv2d1_filters_size = 5 # 9
conv2d2_filters_numbers = 8
conv2d2_filters_size = 1
conv2d3_filters_numbers = 1
conv2d3_filters_size = 3 # 5
...
# conv1d1_filters_numbers = 8
# conv1d1_filters_size = 9
# conv1d2_filters_numbers = 8
# conv1d2_filters_size = 1
# conv1d3_filters_numbers = 1
# conv1d3_filters_size = 5

# class Net1D(nn.Module):
#     def __init__(self, D_in, D_out):
#         super(Net1D, self).__init__()
#         self.conv1 = nn.Conv1d(1, conv1d1_filters_numbers, conv1d1_filters_size)
#         self.conv2 = nn.Conv1d(conv1d1_filters_numbers, conv1d2_filters_numbers, conv1d2_filters_size)
#         self.conv3 = nn.Conv1d(conv1d2_filters_numbers, 1, conv1d3_filters_size)
