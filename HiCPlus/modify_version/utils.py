...
def matrix_extract(chrN1, chrN2, binsize, hicfile, factor, maxsize):

    #result = hicstraw.straw('observed', 'NONE', hicfile, str(chrN1),str(chrN2),'BP',binsize)
...
def train_matrix_extract(chrN1, binsize, hicfile, factor, maxsize):
    # result = hicstraw.straw('observed', 'NONE', hicfile, str(chrN1),str(chrN1),'BP',binsize)
